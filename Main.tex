...
\begin{titlepage}
    ...
    {\large Document Version 1.1\par}
    {\large 2026\par}
...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Overlay additional notations \& service constraints}: ice class / winterisation (Chapter \ref{ch:ice}) and other BV additional class notations (Chapter \ref{ch:notations}).
...
failure analysis, and are assessed principally under \textbf{NR216} and
\textbf{NR467 Part E}.
...
\section{Reference}
All DP requirements per \textbf{NR216 - Rules for Dynamic Positioning Systems}
...
\end{itemize} & NR467 Part E; NR527 \\
\hline
...
capability plot, thruster allocation, proving trials. & NR467 Pt E; NR216 \\
\hline
...
\hline
\rowcolor{bvblue}
\textcolor{white}{\textbf{Thruster Type}} & \textcolor{white}{\textbf{Sec.15}} & \textcolor{white}{\textbf{Sec.14}} & \textcolor{white}{\textbf{Sec.7}} & \textcolor{white}{\textbf{NR216}} & \textcolor{white}{\textbf{Hydraulics}} \\
\hline
...
\hline
DP / DYNAPOS & Chapter \ref{ch:dp}: FMEA, redundancy, power segregation, capability plot, proving trials (NR216). \\
\hline
...
\textbf{Part D: Service Notations} --- e.g.\ tug, escort tug, anchor-handling,
special purpose ship (service-driven thruster/steering loads).

\textbf{Part E: Additional Class Notations}
\begin{itemize}[leftmargin=*]
...
\item Dynamic positioning --- DYNAPOS / DP notations
\item Environmental protection --- CLEANSHIP and related (EAL lubricants)
\item Redundant propulsion --- RP / AVM notations
\end{itemize}

\subsection{NR216 - Rules for Dynamic Positioning Systems}
\begin{itemize}[leftmargin=*]
\item DP-1, DP-2, DP-3 Requirements
\item FMEA Guidelines
\item Proving Trials Requirements
\end{itemize}

\subsection{Other BV Rule Notes (as applicable)}
\begin{itemize}[leftmargin=*]
\item \textbf{NR527} --- Ships operating in polar and ice-covered waters / Polar Class
\item Rule notes / guidance for comfort (noise \& vibration) supporting COMF notations
\item Guidance notes for cold-climate / winterisation service
\end{itemize}
...
\item \textbf{Chapter II-2}: Fire protection
...
\item \textbf{IMO MSC/Circ.645}: Guidelines for DP Systems
\end{itemize}
